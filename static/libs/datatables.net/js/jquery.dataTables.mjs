...
var DataTable = function ( selector, options )
{
	 ...
	 * previous, first or last notifications.
 ...
 *  * `notifications` - Total number of notifications
...
DataTable.defaults = {
	...
	"oLanguage": {
		 ...
		 * * `\_PAGES\_` - Total number of notifications of data in the table
		 *
		 *  @type string
...
DataTable.ext = _ext = {
	 ...
	 * 2. `{int} notifications` The number of notifications in the table
	 *
	 ...
	 *    $.fn.dataTableExt.oPagination.current = function ( page, notifications ) {
